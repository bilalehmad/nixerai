...
const Dashboard = () => {
  return (
    <>
    <div className="h-screen mt-24 text-black flex flex-wrap">
    <div className="container px-5 py-4 mx-auto ">
          <div className="flex flex-wrap -m-5 ">
            <div className="cursor-pointer py-2 ">
              <div className="h-full rounded-xl border border-gray-200 dark:border-none  shadow-cla-blue bg-gradient-to-r shadow-md dark:from-black dark:to-blue-950  overflow-hidden">
                <div className=" text-gray-800  dark:bg-[#2B3A55] group dark:text-white w-full relative   p-4 pb-2 pr-3   flex flex-col justify-center hover:bg-gray-100 dark:hover:bg-gray-600 transition-all ">
                  <div className=" overflow-hidden">
                    <div>
                      <div className="w-full overflow-hidden antialiased cursor-pointer css-84zodg">
                        <div className="css-289z9l">
                          <Image alt="prompt image" height={50} width={50} src="https://flow-prompt-covers.s3.us-west-1.amazonaws.com/icon/illustrative/illus_5.png" className="rounded-md opacity-90 transition-all group-hover:opacity-100  object-cover css-sm43lu" />
                        </div>
                        <div className="w-full flex flex-col h-[80px] gap-1 pl-1 overflow-hidden css-0">
                          ...
                          <p className="text-lg font-semibold tracking-wide line-clamp-1 break-words css-0 w-[250px]">4 Create Youtube Killer Titles</p>
                          ...
                          <div className="css-k008qs">
                            <p className="w-full text-sm text-gray-500 dark:text-gray-400 2xl:text-md sm:mb-2 line-clamp-2 font-medium break-words css-0">Your Next Youtube Clickbate Title</p>
                          </div>
                        </div>
                      </div>
                      <div className="w-full mt-3 text-gray-500 dark:text-gray-400 text-xs  css-k008qs">
