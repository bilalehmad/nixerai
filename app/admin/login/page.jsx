...
const UserLogin = () => {
  ...
  return (
    <div className="w-full mt-8 dark:bg-gray-700 sm:w-1/3 bg-white  flex items-start justify-center h-[400px] shadow-lg border border-gray-300 rounded-md ">
        <button 
            type='button'
            class="flex items-center mt-16 bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none ">
