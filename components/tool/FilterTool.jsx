...
const FilterTool = ({category,isChecked,setIsChecked,isOpen,setIsOpen,setFilterPage}) => {
  ...
  return (
    <>    
        <div className='w-1/2 sm:w-[400px]'>
            <button type='button' onClick={handleButton} className='border border-gray-200  dark:border-gray-400 dark:placeholder-gray-400 dark:text-white dark:bg-gray-700 active:border-gray-200 dark:active:border-gray-400 duration-300 active:text-white bg-white px-3 py-1 md:py-2 w-full flex item-center justify-center font-medium rounded-md tracking-wider'>
