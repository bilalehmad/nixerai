...
function PriceCard({data,short,highlight}) {
  ...
  return (
    <>
        <div class="css-1vzolaf py-4">
            <h2 class={`chakra-heading font-medium ${highlight === "TRUE" ? ("text-gray-50") : ("text-gray-800")}   dark:text-white`}>{short}</h2>
            <p class={`chakra-text ${highlight === "TRUE" ? ("text-gray-300") : ("text-gray-700")}  text-xs dark:text-[#9094a6]`}>Joined through any of these ways:</p>
            <hr aria-orientation="horizontal" class="chakra-divider css-1ko8k8q py-2 dark:border-gray-400" />
            
            {price.map((item,index) => (
                    <div class="chakra-stack css-ywqc9 py-2 px-2">
                        <div class="css-1bf7e4w">
                        ...
                        <p class={`chakra-text css-763daw ${highlight === "TRUE" ? ("text-gray-50") : ("text-gray-800")} dark:text-gray-400 text-sm `}>{item}</p>
                    ...
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    //         <svg width="calc(1rem * 1.5)" height="calc(1rem * 1.5)" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0ACE82"><path d="M8.99978 17.9992C8.99878 17.9992 8.99778 17.9992 8.99578 17.9992C8.72878 17.9982 8.47477 17.8913 8.28777 17.7013L4.28778 13.6393C3.89978 13.2453 3.90478 12.6123 4.29878 12.2253C4.69278 11.8383 5.32478 11.8422 5.71278 12.2362L9.00577 15.5802L18.2938 6.29325C18.6848 5.90225 19.3168 5.90225 19.7078 6.29325C20.0988 6.68325 20.0988 7.31725 19.7078 7.70725L9.70777 17.7073C9.51977 17.8943 9.26478 17.9992 8.99978 17.9992Z" fill="currentColor"></path></svg>
                    //     </div>
                    //     <p class="chakra-text css-763daw">Up to 1,700 upscales or unzooms per month</p>
                    // </div>
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    //         <svg width="calc(1rem * 1.5)" height="calc(1rem * 1.5)" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0ACE82"><path d="M8.99978 17.9992C8.99878 17.9992 8.99778 17.9992 8.99578 17.9992C8.72878 17.9982 8.47477 17.8913 8.28777 17.7013L4.28778 13.6393C3.89978 13.2453 3.90478 12.6123 4.29878 12.2253C4.69278 11.8383 5.32478 11.8422 5.71278 12.2362L9.00577 15.5802L18.2938 6.29325C18.6848 5.90225 19.3168 5.90225 19.7078 6.29325C20.0988 6.68325 20.0988 7.31725 19.7078 7.70725L9.70777 17.7073C9.51977 17.8943 9.26478 17.9992 8.99978 17.9992Z" fill="currentColor"></path></svg>
                    //     </div>
                    //     <p class="chakra-text css-763daw">Up to 4,250 background removals per month</p>
                    // </div>
                    // <hr aria-orientation="horizontal" class="chakra-divider css-fx6kne" />
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    //         <svg width="calc(1rem * 1.5)" height="calc(1rem * 1.5)" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0ACE82"><path d="M8.99978 17.9992C8.99878 17.9992 8.99778 17.9992 8.99578 17.9992C8.72878 17.9982 8.47477 17.8913 8.28777 17.7013L4.28778 13.6393C3.89978 13.2453 3.90478 12.6123 4.29878 12.2253C4.69278 11.8383 5.32478 11.8422 5.71278 12.2362L9.00577 15.5802L18.2938 6.29325C18.6848 5.90225 19.3168 5.90225 19.7078 6.29325C20.0988 6.68325 20.0988 7.31725 19.7078 7.70725L9.70777 17.7073C9.51977 17.8943 9.26478 17.9992 8.99978 17.9992Z" fill="currentColor"></path></svg>
                    //     </div>
                    //     <p class="chakra-text css-763daw">Up to 5 pending jobs</p>
                    // </div>
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    //         <svg width="calc(1rem * 1.5)" height="calc(1rem * 1.5)" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0ACE82"><path d="M8.99978 17.9992C8.99878 17.9992 8.99778 17.9992 8.99578 17.9992C8.72878 17.9982 8.47477 17.8913 8.28777 17.7013L4.28778 13.6393C3.89978 13.2453 3.90478 12.6123 4.29878 12.2253C4.69278 11.8383 5.32478 11.8422 5.71278 12.2362L9.00577 15.5802L18.2938 6.29325C18.6848 5.90225 19.3168 5.90225 19.7078 6.29325C20.0988 6.68325 20.0988 7.31725 19.7078 7.70725L9.70777 17.7073C9.51977 17.8943 9.26478 17.9992 8.99978 17.9992Z" fill="currentColor"></path></svg>
                    //     </div>
                    //     <p class="chakra-text css-763daw">Private generations</p>
                    // </div>
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    //         <svg width="calc(1rem * 1.5)" height="calc(1rem * 1.5)" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0ACE82"><path d="M8.99978 17.9992C8.99878 17.9992 8.99778 17.9992 8.99578 17.9992C8.72878 17.9982 8.47477 17.8913 8.28777 17.7013L4.28778 13.6393C3.89978 13.2453 3.90478 12.6123 4.29878 12.2253C4.69278 11.8383 5.32478 11.8422 5.71278 12.2362L9.00577 15.5802L18.2938 6.29325C18.6848 5.90225 19.3168 5.90225 19.7078 6.29325C20.0988 6.68325 20.0988 7.31725 19.7078 7.70725L9.70777 17.7073C9.51977 17.8943 9.26478 17.9992 8.99978 17.9992Z" fill="currentColor"></path></svg>
                    //     </div>
                    //     <p class="chakra-text css-763daw">Priority infrastructure</p>
                    // </div>
                    // <div class="chakra-stack css-ywqc9">
                    //     <div class="css-1bf7e4w">
                    ...
                    //     </div>
                    //     <p class="chakra-text css-763daw">Relaxed generation queue</p>
                    // </div>
