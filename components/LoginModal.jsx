        ...
        {/* <div className="flex items-start justify-end p-2 border-b rounded-t dark:border-gray-600">
                ...
                <div class="w-full flex ">
                    ...
                    <div class="bg-white text-gray-700  px-4 py-8 flex flex-col  w-full h-screen md:w-6/12 shadow-lg">
                        ...
                        <p className='text-xs py-8 relative bottom-0'>By continuing, you agree to NixerAI <Link href='#' className='underline'> Terms and Conditions</Link>.<br /> Read our <Link href='#' className='underline'> Privacy Policy </Link>.</p>
