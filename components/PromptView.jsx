...
function PromptView({post,isPageLoading,setPageIsLoading}) {
    ...
    const [chatResponce, setChatResponce] = useState(null);
    ...
    const sendMessage = async (message) => {
        ...
        .then(data => {
            ...
            setIsLoading(false);
            setAction(true);
            //data.length == 0 ? setSearchTimeout(false) : setSearchTimeout(true);
        })
        .catch(error => {
            // Handle error
            setIsLoading(false);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 ...
                 {isPageLoading ? (
                    ...
                    <div role="status" class="w-full p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
                        ...
                        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-8"></div>
                        <div class="flex items-center mt-4 space-x-3">
                        ...
                        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-36 mt-8"></div>
                        <div class="h-8 bg-gray-200 rounded-lg dark:bg-gray-700 w-8 mt-2.5 mb-8"></div>
                        <span class="sr-only">Loading...</span>
                    </div>
                 ...
                 <div className='col-span-1 py-5 w-full '>
                    <div className=' text-gray-900 dark:text-white border-2 w-full rounded-md'>
                        ...
                        {(isLoading && !action) && (
                            <div role="status" class="w-full p-4 animate-pulse md:p-6">
                        
                            <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-16 mb-8"></div>
                            <div class="flex items-center mt-4 space-x-3">
                        ...
                        {action && (
                            <div className=' px-5 py-2 scroll-m-2 '>
                            <h5 className='font-staoshi font-semibold text-sm py-5'>
                                <span className=' text-gray-900 dark:text-white  text-left'>Output</span>
                            </h5>
                            <div className='h-[250px] overflow-x-auto'>
                            
                                <p className='text-gray-900 dark:text-white font-semibold text-sm pb-5'>
                                    {chatResponce}
                                </p>
                        ...
                        <div className='px-5'>
                            ...
                            <button className='cursor-pointer' onClick={handleModalButton}>
                                <Image src='/assets/images/chatgpt.png' width={30} height={30} />
