                  ...
                  <div className=" overflow-hidden">
                    <div>
                        <div className="flex items-center rounded-lg shadow md:max-w-xl " >
                            {thumbnail ? (
                            <Image width={50} height={50} className="object-cover w-48 rounded-t-lg h-36  md:w-48 md:rounded-none md:rounded-l-lg " src={thumbnail} alt="" />
                            ): (
                            ...
                            <div className="w-full flex flex-col h-[130px] gap-1 pl-3 overflow-hidden css-0">
                                ...
                                <div className="w-full flex justify-between text-sm  h-[80px] ">
                                    <div className="inline-flex w-full items-end justify-start p-0.5 mr-2 overflow-hidden text-sm font-medium transition-all rounded-sm  ease-in duration-75  ">
                                        ...
                                        <   svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" className="stroke-gray-600 dark:stroke-gray-400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><g fill="none" fillRule="evenodd"><path d="M18 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8c0-1.1.9-2 2-2h5M15 3h6v6M10 14L20.2 3.8"/></g></svg>
                                        </Link>
                                        <span className="relative px-1 py-0.5 top-[2px] cursor-pointer  ease-in duration-75 bg-none  rounded-md group-hover:bg-opacity-0">
                                    ...
                                    <div className="inline-flex justify-end items-end w-full dark:text-gray-400 text-xs p-0.5 mr-2">
